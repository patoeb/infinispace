 ...
 */
namespace Infinispace\Checkout\Block\Checkout;
...
class LayoutProcessor extends \Magento\Checkout\Block\Checkout\LayoutProcessor
{
    ...
    public function process($jsLayout)
    {
        ...
        unset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']);
        return $jsLayout;
    }
